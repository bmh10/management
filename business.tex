...
\section{Business Development Plan}
  ...
  In order to effectively plan for the future we have decided on some primary goals. Our primary shorterm goals are as follows.

    1. Maximise number of sales and expand business hopefully using money from investors
  ...
  We plan to keep our sales process and pricing structure the same as during the previous 6 months...
...
installations
 ...
 - Odeon, Alton Towers, Thorpe Park?
  ...
  We aim to maximize the number of transations and arerage transation value while reducing cost of retention as we are mainly focussed on novelty consumers who aer first time buyers.
